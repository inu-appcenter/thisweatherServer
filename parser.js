...
request(weatherUrl, function(err, res, data){
  if(!err && res.statusCode == 200){
    fs.writeFile('./public/xml/localWeather.xml',data,'utf8',function(error){
    });
...
request(midtermUrl, function(err, res, data){
  if(!err && res.statusCode == 200){
    fs.writeFile('./public/xml/midtermWeather.xml',data,'utf8',function(error){
    });
...
request(pm10Url, function(err, res, data){
  if(!err && res.statusCode == 200){
    fs.writeFile('./public/xml/localPM10.xml',data,'utf8',function(error){
    });
